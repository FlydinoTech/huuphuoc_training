                    ...
                    <section class="panel">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>Admin</td>
                                <td class="center">
                                    <a href="{{route('admin.user.edit')}}" title="" class="btn btn-info"><i class="fa fa-edit "></i> Sửa</a>
                                    <a href="{{route('admin.user.del')}}" title="" class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</a>
                                </td>
                            </tr>
                            {{-- @endforeach --}}
                            </tbody>
